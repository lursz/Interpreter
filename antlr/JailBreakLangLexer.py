...
def serializedATN():
    return [
        ...
        1,0,0,0,53,205,1,0,0,0,55,208,1,0,0,0,57,212,1,0,0,0,59,216,1,0,
        ...
        203,204,5,69,0,0,204,52,1,0,0,0,205,206,5,79,0,0,206,207,5,82,0,
        0,207,54,1,0,0,0,208,209,5,65,0,0,209,210,5,78,0,0,210,211,5,68,
        0,0,211,56,1,0,0,0,212,213,5,78,0,0,213,214,5,79,0,0,214,215,5,84,
...
class JailBreakLangLexer(Lexer):
    ...
    literalNames = [ "<INVALID>",
            ...
            "'RIGHT'", "'UP'", "'DOWN'", "'TRUE'", "'FALSE'", "'OR'", "'AND'", 
            "'NOT'", "'=='", "'!='", "'<'", "'>'", "'('", "')'", "'*'", 
            "'/'", "'+'", "'-'" ]
